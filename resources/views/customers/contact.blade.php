  ...
  <form action="customers/{{$customer->id}}/edit">
    ...
    <a href="/customers/{{$customer->id}}/edit">
      ...
      @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 10)
        ...
        <a  href="/optimize/customers/consolidateDuplicates/?email={{$customer->email}}" class="btn btn-sm btn-primary" type="submit" title="Enviar Cliente a RD Station"  style="color: white; margin-top: 5px;">Buscar duplicados</a>
      @endif
