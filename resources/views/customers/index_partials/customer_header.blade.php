  ...
  <p class="mb-2">
    @if($visiblePhone)
      ...
      <span class="d-inline-flex align-items-center phone-copy-wrapper" style="gap:8px;">
        <a href="/customers/{{ $customer->id }}/show" class="text-decoration-none me-2 badge badge-success phone-pill" style="background-color:#21d196;color:#fff;border-radius:4px;padding:2px 6px;font-weight:500;">
          {{ $visiblePhone }}
        </a>
