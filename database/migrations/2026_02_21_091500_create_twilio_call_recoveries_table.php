...
return new class extends Migration
{
    ...
    {
        Schema::create('twilio_call_recoveries', function (Blueprint $table) {
            $table->id();
            $table->string('call_sid', 191)->unique();
            ...
            $table->string('contact_msisdn', 64)->nullable()->index();
            $table->string('direction', 32)->nullable();
            $table->string('status_text', 64)->nullable();
    ...
    {
        Schema::dropIfExists('twilio_call_recoveries');
    }
};
