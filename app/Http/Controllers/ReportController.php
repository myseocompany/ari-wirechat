        ...
        $callback = function () use ($rows, $headers): void {
            ...
            foreach ($rows as $row) {
                fputcsv($handle, [
                    ...
                    $row->tag_names ? str_replace('||', ', ', (string) $row->tag_names) : '',
                    $row->llm_used ? 'Si' : 'No',
