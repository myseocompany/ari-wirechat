...
interface ManualProductionStepProps {
  value?: number;
  onNext: (value: number) => void;
  onBack: () => void;
}

export default function ManualProductionStep({
  value,
  onNext,
  onBack,
}: ManualProductionStepProps) {
  ...
  const suggestedValues = [100, 500, 1000, 2000, 5000];
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900">
          ¿Cuántas empanadas produces por día?
        </h2>
      </div>
